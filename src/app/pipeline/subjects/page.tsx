...
export default function SubjectsPipelinePage() {
    ...
    const handleSeed = async () => {
        ...
        try {
            ...
            const validation = SubjectIngestionSchema.safeParse(parsed);
            ...
            const response = await fetch("/api/pipeline/subjects", {
                method: "POST",
            ...
            if (result.success) {
                setStatus({
                    type: 'success',
                    message: `Successfully seeded ${result.data.count} subjects!`
                });
            } else {
                setStatus({
                    type: 'error',
        ...
        <main style={{
            ...
            <header>
                ...
                <p style={{ color: 'var(--text-secondary)' }}>
                    Bulk seed subjects by pasting a JSON array below.
                </p>
            </header>
            ...
            <section style={{
                ...
                <div style={{ position: 'relative' }}>
                    <textarea
                        ...
                        placeholder={`[\n  {\n    "slug": "math",\n    "title": "Mathematics",\n    "order": 1,\n    "summary": "The language of the universe"\n  }\n]`}
                        style={{
                            width: '100%',
                            height: '400px',
                            background: '#0a0e14',
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 'var(--space-4)' }}>
                    ...
                    >
                        {status.type === 'loading' ? 'Processing...' : 'Seed Subjects'}
                    </button>
                </div>
            </section>
